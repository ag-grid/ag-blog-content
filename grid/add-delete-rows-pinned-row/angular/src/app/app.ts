...
export class App implements OnInit {
  ...
  private setupGrid(): void {
    ...
    this.defaultColDef = {
      ...
      valueFormatter: this.valueFormatter.bind(this),
      cellClassRules: {
        'pinned-cell-editing': (params: any) => params.node.rowPinned && params.value,
      },
    };
  }
  ...
  public onCellEditingStopped(params: CellEditingStoppedEvent): void {
    ...
    const requiredFields: (keyof AthleteData)[] = ['athlete', 'sport', 'date', 'age'];
  ...
  public get pinnedTopRowData(): Partial<AthleteData>[] {
    return [this.inputRow];
  }

  public get rowClassRules(): any {
    return {
